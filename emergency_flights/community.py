...
TRANSLATIONS = {
    "en": {
        ...
        "intel": "Intel",
        "alerts_tab": "Alerts",
        "alerts_title": "Get Notified",
        "alerts_what": "What you'll receive",
        "alerts_setup": "Setup WhatsApp Alerts",
        "alerts_test": "Test & Subscribe",
        "alerts_test_explain": "Enter your WhatsApp number (with country code, e.g. +13125551234). Send Test sends one message right now so you can confirm delivery. Subscribe saves this number so you get automatic alerts whenever flight statuses, prices, or routes change (e.g. when you use Auto refresh or someone else loads the page).",
        "alerts_subscribe_hint": "Alerts are sent when the app detects changes (new/cancelled routes, price changes).",
        "alerts_sms_title": "SMS Alerts",
        "send_test": "Send Test",
        "subscribe_live": "Subscribe to Live Alerts",
        "conflict_news": "Conflict News",
        "community_reports": "Community Reports",
        "ride_sharing": "Ride Sharing",
        "crowdsource_title": "Official Travel Advisories",
        "x_posts_title": "X / Twitter Posts",
        "no_advisories": "No advisories loaded",
        "historical_patterns": "Historical Conflict Patterns",
        "notams_title": "NOTAMs (Aviation notices)",
        "no_notams": "No NOTAMs retrieved for RUH, JED, DMM, IST",
        "notams_error": "Could not load NOTAMs",
        ...
        "arrive_in": "Arrive in",
        "first_flight": "First flight departs",
        "land_at": "Land at destination",
        "wait_until": "Wait until departure",
        "from_now": "from now",
        ...
        "takeoff": "Takeoff",
        "landing": "Landing",
        "search_all": "Search full trip on Google Flights",
    ...
    "zh": {
        ...
        "alerts_tab": "通知",
        "alerts_title": "接收通知",
        "alerts_what": "您将收到以下通知",
        "alerts_setup": "设置 WhatsApp 通知",
        "alerts_test": "测试并订阅",
        "alerts_test_explain": "输入您的 WhatsApp 号码（含国家代码，如 +8613812345678）。「发送测试」会立即发一条消息，确认能收到。「订阅」会保存此号码，之后每当航班状态、价格或路线有变化时（例如您开启自动刷新或有人打开页面时），您都会收到通知。",
        "alerts_subscribe_hint": "仅在检测到变化（新路线/取消、价格变动）时发送通知。",
        "alerts_sms_title": "短信通知",
        "send_test": "发送测试",
        "subscribe_live": "订阅实时通知",
        "conflict_news": "冲突新闻",
        "community_reports": "社区报告",
        "ride_sharing": "拼车出行",
        "crowdsource_title": "官方旅行警告",
        "x_posts_title": "X / 推特帖子",
        "no_advisories": "暂无旅行警告",
        "historical_patterns": "历史冲突模式",
        "notams_title": "NOTAM（航空通告）",
        "no_notams": "未获取到 RUH、JED、DMM、IST 的 NOTAM",
        "notams_error": "无法加载 NOTAM",
        "no_visa": "无需签证",
        "visa_required": "需要签证",
        ...
        "wait_until": "等待起飞",
        "from_now": "后",
        "journey_breakdown": "行程详情",
        "connection_in": "中转等待于",
        "wait_in": "等候于",
        "takeoff": "起飞",
        "landing": "降落",
        "search_all": "在Google Flights搜索全程",
